          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(fontSize: 15, color: _navy.withValues(alpha: 0.5)),
              ),
                ...
                Row(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        'or',
                        style: TextStyle(color: _navy.withValues(alpha: 0.4)),
                      ),
                    ),
                    Expanded(
                      child: Divider(
                ...
                SizedBox(
                  ...
                  child: OutlinedButton(
                    ...
                    style: OutlinedButton.styleFrom(
                      ...
                      side: BorderSide(color: _navy.withValues(alpha: 0.15)),
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(14),
                      ),
                    ),
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      if (_isPassenger && isDriver) {
        ...
        setState(() => _error = 'This account is a driver account. Please select the Driver tab.');
        return;
      }

      if (!_isPassenger && !isDriver) {
        await FirebaseAuth.instance.signOut();
        setState(() => _error = 'This account is a passenger account. Please select the Passenger tab.');
        return;
      }
      ...
      setState(() {
        _error = switch (e.code) {
          'user-not-found' || 'invalid-email' => 'No account found with this email.',
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(color: _navy.withValues(alpha: 0.65)),
                  ),
                  const SizedBox(height: 20),
                  Container(
                    decoration: BoxDecoration(
  ...
  Widget _buildField({
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        prefixIcon: Icon(icon, color: _navy.withValues(alpha: 0.5)),
        suffixIcon: suffix,
        filled: true,
