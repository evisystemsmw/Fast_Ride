...
class _RegisterFormState extends State<_RegisterForm> {
  ...
  Future<void> _signup() async {
    ...
    if (_isDriver && (_idNumberController.text.trim().isEmpty ||
      ...
      child: Column(
        children: [
          ...
          if (_isDriver) ...[
            ...
            const SizedBox(height: 16),
            _field(_licenceController, 'Licence Number', Icons.credit_card_outlined),
            const SizedBox(height: 16),
            _field(_carModelController, 'Car Model', Icons.directions_car_outlined),
            const SizedBox(height: 16),
            _field(_plateController, 'Vehicle Plate Number', Icons.pin_outlined),
          ],
          const SizedBox(height: 16),
          ...
          if (!_isDriver) ...[
            ...
            Row(
              children: [
                Expanded(child: Divider(color: _navy.withOpacity(0.2), thickness: 1)),
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 12),
                  child: Text('or', style: TextStyle(color: _navy.withOpacity(0.4))),
                ),
                Expanded(child: Divider(color: _navy.withOpacity(0.2), thickness: 1)),
              ],
            ),
